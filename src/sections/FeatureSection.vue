    ...
    <div id="features" class="container mx-auto px-5">
        <section class="py-16">
            <div class="w-4/5 md:w-3/5 mx-auto">
                <h2 class="text-3xl md:text-4xl font-semibold font-theme-heading text-center">Agentes Insignia</h2>
                <p class="text-theme-grayish-blue text-center mt-7 font-theme-content text-lg">
                    Nuestros agentes prediseñados se integran fácilmente a los sistemas HIS/LIS/PACS/EMR existentes en clínicas, hospitales y centros de salud y pueden ser utilizados para ayudar con una amplia gama de tareas.
                </p>
            </div>
                ...
                <template v-for="feature in features" :key="feature.id">
                    <div v-show="isOpen === feature.id" class="grid gap-32 lg:grid-cols-2 items-center">
                        ...
                        <div>
                            ...
                            <ul class="mt-7 font-theme-content text-lg text-theme-grayish-blue text-center lg:text-left">
                                <li v-for="feature in feature.details.features" :key="feature" class="flex items-center">
                                    <span class="mr-2">✔️</span>
                                    <span class="">{{ feature }}</span>
                                </li>
                            </ul>
                            <div class="flex justify-center lg:justify-start mt-7">
                                <LinkButton btn-type="primary" :link="feature.details.link">Agenda una demo</LinkButton>
                            </div>
                        </div>
                    </div>
                </template>
