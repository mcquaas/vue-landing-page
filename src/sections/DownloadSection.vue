    ...
    <div id="download-section" class="container mx-auto px-5 md:w-4/5">
        <section class="py-16 pt-18">
            <div class="w-4/5 md:w-3/5 mx-auto">
                <h2 class="text-3xl md:text-4xl font-theme-heading font-medium text-center">Descarga la extensión</h2>
                <p class="text-theme-grayish-blue text-center text-lg font-theme-content mt-7">Tenemos más navegadores en proceso. Por favor, háznos saber si tienes uno favorito que te gustaría que priorizáramos.</p>
            </div>
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mt-12">
                <div v-for="(download, index) in downloads" :key="download.id" :class="[index === 0 ? 'lg:mb-10' : '', index === 1 ? 'lg:mt-10' : '', index === 2 ? 'lg:mt-20 lg:-mb-10' : '']" class="shadow-lg rounded-lg">
                    ...
                    <div class="my-7">
                        <img class="w-full" src="/images/bg-dots.svg" alt="Dot Background" />
                    </div>
                    <div class="flex justify-center mb-8">
                        <LinkButton btn-type="primary" :link="download.link" class="text-sm">Agregar e Instalar Extensión</LinkButton>
                    </div>
                </div>
            </div>
        </section>
